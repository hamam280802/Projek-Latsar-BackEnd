        ...
        <div className='bg-orange-50 rounded-lg p-4 shadow-md space-y-8'>
            ...
            <div className='flex justify-between space-x-4'>
                <div className='space-y-2 w-[20%] font-semibold text-sm'>
                    <label htmlFor="wilayah">Wilayah</label><br />
                    <select name="wilayah" id="wilayah" className='w-full border focus:border-1 p-2 rounded-md bg-white shadow-md'></select>
                </div>
                <div className='space-y-2 w-[20%] font-semibold text-sm'>
                    <label htmlFor="survei">Jenis Survei</label><br />
                    <select name="survei" id="survei" className='w-full border focus:border-1 p-2 rounded-md bg-white shadow-md'></select>
                </div>
                <div className='space-y-2 w-[20%] font-semibold text-sm'>
                    <label htmlFor="status">Status Kendala</label><br />
                    <select name="status" id="status" className='w-full border focus:border-1 p-2 rounded-md bg-white shadow-md'></select>
                </div>
                <div className='space-y-2 w-[20%] font-semibold text-sm'>
                    <label htmlFor="jenis">Jenis Kendala</label><br />
                    <select name="jenis" id="jenis" className='w-full border focus:border-1 p-2 rounded-md bg-white shadow-md'></select>
                </div>
            </div>
        </div>
